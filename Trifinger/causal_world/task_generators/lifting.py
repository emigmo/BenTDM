...
class LiftingTaskGenerator(BaseTask):
    def __init__(self, variables_space='space_a_b',
        ...
        :param goal_height:
        """
        super().__init__(task_name="lifting",
    ...
    def _set_up_stage_arena(self):
        ...
        self._task_stage_observation_keys = ["tool_block_cartesian_position"]#[
    ...
    def _set_intervention_space_a(self):
        ...
        :return:
        """
        super(LiftingTaskGenerator, self)._set_intervention_space_a()
    ...
    def _set_intervention_space_b(self):
        ...
        :return:
        """
        super(LiftingTaskGenerator, self)._set_intervention_space_b()
        for visual_object in self._stage.get_visual_objects():
