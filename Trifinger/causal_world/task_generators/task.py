...
from causal_world.task_generators.lifting import LiftingTaskGenerator
...
def task_generator(task_generator_id="reaching", **kwargs):
    ...
    if task_generator_id == "picking":
        print(task_generator_id)
        task = PickingTaskGenerator(**kwargs)
    elif task_generator_id == "lifting":
        task = LiftingTaskGenerator(**kwargs)
