...
class BaseDKittyWalk(BaseDKittyUprightEnv, metaclass=abc.ABCMeta):
    ...
    def get_obs_dict(self) -> Dict[str, np.ndarray]:
        ...
        pos_npy_path = "/home/robot/workspace/OCRTOC_software_package_wzt/aruco_ros/aruco_ros/scripts/transform.npy"
        matrix_npy_path = "/home/robot/workspace/OCRTOC_software_package_wzt/aruco_ros/aruco_ros/scripts/matrix.npy"
        # pos = np.load(pos_npy_path)
        # matrix = np.load(matrix_npy_path)
        # torso_track_state.pos = pos
        # torso_track_state.rot = matrix
